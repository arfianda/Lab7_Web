...
<form method="post" action="<?= base_url('admin/artikel/store') ?>" enctype="multipart/form-data">
    <?= csrf_field() ?>
    ...
    <div class="form-group">
        ...
        <textarea id="isi" name="isi" class="form-control" rows="10" required><?= old('isi') ?></textarea>
